    ...
    <section className="text-white text-center py-0 font-bold">
      ...
      <div className="bg-cover bg-center bg-opacity-90 bg-black bg-center h-screen flex items-center justify-center" style={{backgroundImage: "url('https://cdn.sortiraparis.com/images/80/100789/834071-too-restaurant-too-hotel-paris-photos-menu-entrees.jpg')"}}>
        ...
        <div className="bg-cover bg-center bg-opacity-90 bg-center bg-opacity-75 h-screen flex items-center justify-center" style={{backgroundImage: "url('https://galleria.co.ke/storage/2022/05/Web-square-Mbuzi-Munch-4.jpg')"}}>
          <h1 className="text-2xl md:text-4xl">Une expérience culinaire inoubliable. Détendez-vous et laissez-vous charmer : Vivez une expérience culinaire dans un cadre exceptionnel.</h1>
        </div>
